export const recipes = [
  {
    ...
    steps: [
      ...
      { step: "Serve at room temperature or chilled.", number: 9 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Add the peas and broccoli and stir again.", number: 7 },
      {
  ...
  },
  {
    ...
    steps: [
      { step: "Chop the garlic and onions.", number: 1 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Drain and set aside.", number: 3 },
      {
  ...
  },
  {
    ...
    diets: ["gluten free"],
    steps: [
      { step: "To get started heat oven to 35", number: 1 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Serve with salsa, cheese, and sour cream.", number: 4 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Serve warm or cold as a side dish.", number: 7 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add your seasoning cubes and taste for salt.", number: 5 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Serve immediately.", number: 2 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Add onions and cook for 1 minute.", number: 2 },
      {
      ...
      { step: "Add walnuts and serve hot.", number: 5 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add your butternut squash", number: 2 },
      { step: "In a measuring cup add your eggs and milk.", number: 3 },
      { step: "Mix until combined.", number: 4 },
      { step: "Pour over butternut squash.", number: 5 },
      { step: "Sprinkle with pepper and top with cheese.", number: 6 },
      {
        step: "Bake in oven for 30-35 minutes, until middle is slightly firm",
        number: 7,
      },
      { step: "Let it cool for a few minutes", number: 8 },
    ],
    created: false,
  },
  {
    ...
    diets: ["gluten free", "dairy free", "lacto ovo vegetarian", "vegan"],
    steps: [
      { step: "PRESSURE COOKER METHOD", number: 1 },
      {
      ...
      { step: "Drain the beans, reserving the bean broth.", number: 10 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Mix in with Romaine lettuce", number: 2 },
      { step: "Toss in some basalmic vinaigrette", number: 3 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Add the carrot, saut for another 2 minutes.", number: 2 },
      {
      ...
      { step: "Before serving sprinkle with chopped parsley.", number: 5 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    diets: ["gluten free", "dairy free", "lacto ovo vegetarian", "vegan"],
    steps: [
      { step: "Preheat oven to 375 degrees.", number: 1 },
      {
      ...
      { step: "Add cooled corn.", number: 4 },
      { step: "Mix in cumin and vinegar and blend well.", number: 5 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Serve immediately.", number: 4 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Chill for 30 minutes.", number: 2 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add more water as necessary.", number: 11 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Whisk together the dressing ingredients.", number: 3 },
      { step: "Pour the dressing over the salad and toss.", number: 4 },
      { step: "Serve at room temperature or chilled.", number: 5 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Sprinkle the parmesan cheese over the salad", number: 4 },
      { step: "Drizzle your dressing over and serve cool.   ", number: 5 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Serve cold or at room temperature.", number: 5 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Tightly roll the leaf into a bundle.", number: 8 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Pour the dressing over the salad.", number: 4 },
      {
  ...
  },
  {
    ...
    steps: [{ step: "Place everything on a plate!  :)", number: 1 }],
    created: false,
  },
  {
    id: 782622,
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Mix well and roast for 15 minutes.", number: 4 },
      {
      ...
      { step: "Serve with some green salad.", number: 8 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Serve with mashed potatoes and sauce.", number: 6 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Spread the asparagus on in a large skillet.", number: 6 },
      {
      ...
      { step: "Saute over medium heat for 5 minutes.", number: 9 },
      {
        step: "Add the two tablespoons of vegetable stock and cover the skillet.",
        number: 10,
      },
      { step: "Saute 4 minutes.", number: 11 },
      { step: "Remove lid and add the minced garlic.", number: 12 },
      {
  ...
  },
  {
    ...
    diets: ["gluten free", "dairy free", "lacto ovo vegetarian", "vegan"],
    steps: [
      { step: "Get ready two small saucepans.", number: 1 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add cheese to the pasta mixture", number: 5 },
      { step: "Serve and enjoy!", number: 6 },
      { step: "Makes 4 servings, about 2 cups or so", number: 7 },
      { step: "Calories per serving:  235,  Fat:  2.", number: 8 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Cut the onion roughly into chunks", number: 2 },
      {
      ...
      { step: "Coat the veggies in the cooked amaranth", number: 7 },
      { step: "Tear a few rocket leaves", number: 8 },
      {
        step: "Toss together and there you have it, an unusual roast veggie salad!",
        number: 9,
      },
      { step: "Serve warm", number: 10 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Serve with a dollop of sour cream.", number: 9 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Serve immediately.", number: 7 },
    ],
    created: false,
  },
  {
    ...
    diets: ["dairy free", "lacto ovo vegetarian", "vegan"],
    steps: [
      { step: "Preheat oven to 375 F.", number: 1 },
      {
      ...
      { step: "Bake 12-15 minutes.", number: 4 },
      { step: "Garnish and serve.", number: 5 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      { step: "Food", number: 1 },
      { step: "Preheat oven to 300F.", number: 2 },
      {
      ...
      { step: "Transfer to platter.", number: 5 },
      {
      ...
      { step: "Sprinkle with chopped cilantro.", number: 9 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Mix everything together well.", number: 4 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Tear the lettuce into mouth-siazed peices.", number: 6 },
      {
        step: "Cut the red cabbage into thin slices. Grate the carrot.",
        number: 7,
      },
      { step: "Mix together in a bowl.", number: 8 },
      {
        step: "Tear the chicken into large pieces and add to the salad.",
        number: 9,
      },
      { step: "Remove the tomato salsa from the fridge.", number: 10 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add greens for about five minutes until soft", number: 6 },
      { step: "Add nutmeg, sea salt and pepper to taste", number: 7 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Add sprinkles for garnishing", number: 6 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Peel and chop mango", number: 2 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Garnish with crushed peanuts and serve.", number: 2 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "At least 15 minutes longer.", number: 7 },
      {
        step: "Serve hot, with a little vinegar drizzled onto each serving, and a sprinkling of minced",
        number: 8,
      },
      { step: "Scallions or parsley on top, if desired.", number: 9 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Add the chopped onions and leeks.", number: 2 },
      { step: "Saute until translucent about 4 minutes.", number: 3 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Remove filets to beds of lettuce.", number: 4 },
      {
      ...
      { step: "Garnish with fresh cilantro and lime wedges.", number: 6 },
      { step: "Sprinkle with salt and pepper to taste.", number: 7 },
      { step: "Serve immediately.", number: 8 },
    ],
    created: false,
  },
  {
    ...
    steps: [
      ...
      { step: "Add the oil and vinegar with the salt.", number: 5 },
      {
  ...
  },
  {
    ...
    diets: [],
    steps: [
      { step: "Preheat oven to 37", number: 1 },
      {
      ...
      { step: "Transfer to a colander.", number: 5 },
      {
      ...
      { step: "Season the outside with salt and pepper.", number: 9 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Heat oil in a large skillet.", number: 4 },
      {
      ...
      { step: "Add the filling.", number: 9 },
      {
        step: "Place over the other half of mashed potatoes.",
        number: 10,
      },
      { step: "Heat your oven at 39", number: 11 },
      {
        step: "Put the casserole in the oven. Cook for 40 minutes.",
        number: 12,
      },
      { step: "Don't serve immediately.", number: 13 },
      { step: "Let it cool for at least half an hour.", number: 14 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add mixture to the pot.", number: 6 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Serve with basmati rice.", number: 6 },
    ],
    created: false,
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Preheat oven to 350F.", number: 7 },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      { step: "Add more water if necessary.", number: 8 },
      {
  ...
  },
  {
    ...
    diets: ["gluten free", "dairy free", "lacto ovo vegetarian"],
    steps: [
      { step: "Begin by preparing the pancake batter.", number: 1 },
      {
      ...
      { step: "Drizzle with more sauce and there you go.", number: 9 },
    ],
    created: false,
  },
  {
    ...
    diets: ["gluten free", "lacto ovo vegetarian"],
    steps: [
      { step: "Preheat oven to 450F.", number: 1 },
      { step: "Spray a cookie sheet with nonstick spray.", number: 2 },
      {
        step: "Toss butternut squash with about 1 tbsp olive oil (possibly less, just enough to coat) and season with salt and pepper.",
        number: 3,
      },
      { step: "Spread in one layer on cookie sheet.", number: 4 },
      {
